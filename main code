...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for ONE PIECE RED\n\n");
	printf("\t\t\tpress 2 for ONE PIECE GOLD\n\n");
	printf("\t\t\tpress 3 for ONE PIECE Z\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : ONE PIECE RED\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : ONE PIECE GOLD\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 14-11-2022\n");
        printf("\t                                              Time      : 03:00pm\n");
        printf("\t                                              Hall      : 03\n");
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : ONE PIECE Z \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 14-11-2022\n");
        printf("\t                                              Time      : 7:00pm\n");
        printf("\t                                              Hall      : 04\n");
